...
swagger-serverstub:
	${SWAGGER_CMD} generate server -A WorkflowManager -t pkg/swagger -f https://raw.githubusercontent.com/smothiki/workflow-manager/doctor/api/swagger-spec/swagger.yml
